...
export default function ClientCard({ client }) {
  ...
  return (
    <article className={`client-card client-card--${client.currentStatus.toLowerCase()}`}>
      ...
      <div className="client-card__meta">
        <div>
          ...
          <span className="metric-value">{client.technicalAccountManager}</span>
        </div>
        <div>
          <span className="metric-label">AM</span>
          <span className="metric-value">{client.accountManager}</span>
        </div>
      </div>
